      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            ...
            > */}
            <Link to="contact" smooth duration={500}  className="group text-white w-fit px-6 py-2 my-2 text-lg flex items-center rounded-md bg-gradient-to-r from-pink-300 to-purple-700 cursor-pointer">
              Say Hi!
